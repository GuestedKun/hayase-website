...
const HomeMeta = () => (
	<Meta
		title="Hayase Studies"
		description="Hayase Studies is a web proxy service with support for many sites. Unblock websites on Chromebooks at school and work."
		faq={[
			{
			...
			{
				name: 'Is Hayase Studies open source?',
				acceptedAnswer: {
					text: 'Nah',
				},
			},
			{
				name: 'What games are on Hayase Studies?',
				acceptedAnswer: {
