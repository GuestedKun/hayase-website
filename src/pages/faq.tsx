...
const WebsiteAIOLink = ({ children }: { children?: ReactNode }) => (
	<ObfuscatedThemeA
		href="https://github.com/GuestedKun/website-embedded/website-aio#website-aio"
		title="Invite"
	>
		{children}
	</ObfuscatedThemeA>
...
const GitLink = ({ children }: { children?: ReactNode }) => (
	<ObfuscatedThemeA
		href="https://github.com/GuestedKun/website-embedded/website"
...
const FAQMeta = () => {
	...
	return (
		<Meta
			title="FAQ"
			description="Hayase Studies's frequently asked questions."
			faq={[
				{
